...
public class Analizador2 {
    ...
    //constructores
    public Analizador2(ArrayList<tokensLexemas> listaTokensLexemas){
            ...
            for (int j = 0; j < texto[i].length(); j++) {   //lee caracter      
                ...
                switch(estado){
                    ...
                    case 9:
                        ...
                        if (valorAsciiSiguiente == 108 && valorAsciiSiguiente == 101 && valorAsciiSiguiente == 101 && valorAsciiSiguiente == 114) {  
                            estado = 1;             //LEER
                        
                        
                        
                        
                        } else if (valorAsciiSiguiente == 100 && valorAsciiSiguiente == 111) {  //letra
                            estado = 1;//abecedario mayusculas minusculas
                            ...
                            numeroToken = 1;
                            tipoToken = "PALABRA RESERVADA LEER";
                            estado = 0;
                        }
                    break;
    ...
    public  int caracter(int posicionAscii){//primer caracter
        //(minusculas ASCII 97-122       o       mayusculas ASCII 65-90)
           ...
           if (posicionAscii == 108 && posicionAscii == 101 && posicionAscii == 101 && posicionAscii == 114) {
            return 1;                   //LEER     
            
            
            
    } else if ((posicionAscii >= 97 && posicionAscii <= 122) || (posicionAscii >= 65 && posicionAscii <= 90)) {
            return 10;//abecedario    
            ...
            }   else if (posicionAscii == 100 && posicionAscii == 111) {        
            return 8;           //do
